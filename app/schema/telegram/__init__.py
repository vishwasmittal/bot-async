...
from app.schema.telegram.chat import *
...
from app.schema.telegram.reply_keyboard_markup import *
...
from app.schema.telegram.user import *

__all__ += user.__all__

# ----------- telegram methods ----------- #

from app.schema.telegram.send_message import *
